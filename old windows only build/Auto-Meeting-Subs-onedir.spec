...
a = Analysis(
    ...
    datas=[('C:/Python/Environments/auto-meeting-sub-env/Lib/site-packages/lightning_fabric/version.info', 'lightning_fabric'),
           ...
           ('D:\Github Repos\Personal Projects\Auto-Meeting-Subs\Auto-Meeting-Subs.ico','.')],
    hiddenimports=['pyannote.audio.models','pyannote.audio.models.segmentation','pyannote.audio.models.embedding'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
